...
/**
 * Student Calendar Client Component
 * 
 * Client-side component that fetches bookings using React Query
 * and displays them in a calendar view.
 */
export default function StudentCalendarClient({ userId, userEmail }: StudentCalendarClientProps) {
    ...
    <RealtimeProvider userId={userId}>
      <div className="min-h-screen bg-background">
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          {/* Calendar Section */}
          <div className="mb-6">
            <h2 className="text-xl font-semibold text-card-foreground mb-2">Your Flight Schedule</h2>
            <p className="text-muted-foreground">
              View all your upcoming flights and lessons in calendar format.
            </p>
          </div>
              ...
              <CardContent>
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-card-foreground">{selectedEvent.instructorName}</p>
                  </div>
                  <div>
